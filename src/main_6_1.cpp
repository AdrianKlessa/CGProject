...
const double boxLifetime = 6.5f; // after this time a new box spawns (with some element of randomness)
const double explosionDistance = 12.0f; // how far away the mine is from the player when it triggers
